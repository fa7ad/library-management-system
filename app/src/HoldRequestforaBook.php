...
if ($_POST['isbn'] != null) { // ISBN
	...
	//Our SQL Query
	$sql_query1 = "Select B.ISBN, Title, Edition, COUNT(CopyId) AS copynum From book AS B, bookcopy AS BC Where Title LIKE '%$title%' OR B.ISBN = BC.ISBN AND IsReserved = 0 AND IsHold = 0 AND IsChecked = 0 AND IsDamaged = 0 Group by B.ISBN";
	//Run our sql query
	$result1 = mysqli_query($link, $sql_query1)  or die(mysqli_error($link));
	if ($result1 == false) {
	...
	$sql_query2 = "Select B.ISBN, Title, Edition, COUNT(CopyId) AS copynum From book AS B, bookcopy AS BC Where Title Like '%$title%' OR B.ISBN = BC.ISBN AND IsReserved = 1 AND IsHold = 0 AND IsChecked = 0 AND IsDamaged = 0 Group by B.ISBN";
	//Run our sql query
	$result2 = mysqli_query($link, $sql_query2)  or die(mysqli_error($link));
	if ($result2 == false) {
		echo 'The query by ISBN failed.';
	...
	//Our SQL Query
	$sql_query1 = "Select B.ISBN, Title, Edition, COUNT(CopyId) AS copynum From book AS B, bookcopy AS BC, author AS A Where A.Author Like '%$author%' OR A.ISBN = B.ISBN AND B.ISBN = BC.ISBN AND IsReserved = 0 AND IsHold = 0 AND IsChecked = 0 AND IsDamaged = 0 Group by B.ISBN";
	//Run our sql query
	$result1 = mysqli_query($link, $sql_query1)  or die(mysqli_error($link));
	if ($result1 == false) {
	...
	//Our SQL Query
	$sql_query2 = "Select B.ISBN, Title, Edition, COUNT(CopyId) AS copynum From book AS B, bookcopy AS BC, author AS A Where A.Author Like '%$author%' OR A.ISBN = B.ISBN AND B.ISBN = BC.ISBN AND IsReserved = 1 AND IsHold = 0 AND IsChecked = 0 AND IsDamaged = 0 Group by B.ISBN";
	//Run our sql query
	$result2 = mysqli_query($link, $sql_query2)  or die(mysqli_error($link));
	if ($result1 == false) {
		echo 'The query by Author failed.';
